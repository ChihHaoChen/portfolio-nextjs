              ...
              <div key={key}>
                ...
                <div className="flex items-center space-x-2 space-around">
                  <p className="font-semibold">
                    {showDate(educationItem.dateFrom)} -{' '}
                    {showDate(educationItem.dateTo)} |
                  </p>
                  <GoLocation />
        ...
        <div>
          ...
          {experiences.map((experience, key) => (
            <div key={key}>
              ...
              <div className="flex items-center space-x-2 space-around">
                <p className="font-semibold">
                  {showDate(experience.dateFrom)} -{' '}
                  {showDate(experience.dateTo)} |
                </p>
                <GoLocation />
              ...
              <ul className="pl-5 list-disc">
                {experience.workItems.map(({ item, link }, key) => (
                  <li
                    key={key}
                  ...
                  >
                    {link && (
                      <a href={link} target="_blank">
                        <FiAward className="w-4 h-4 mr-3 cursor-pointer text-orange hover:text-blue-500" />
                      </a>
                    )}
                    {item}
                  </li>
